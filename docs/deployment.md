...
5. Record your seed offline, and the URLs of your relays next to it (they are not secret, but they are not derived from the seed either). Restore needs the seed and at least one relay that still holds the backup; no other secret or file.
