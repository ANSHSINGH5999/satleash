...
| Recovery (real) | Two-channel drill, verify, wipe, restore with one relay off, funds back | Funds return less fees | 1,492,866 of 1,493,060 sats, 194 sats fees, 36.4 to 40.9 s across eleven runs | PASS | drill runs, e2e |
