...
| 8 | 1:20 to 1:38 | Recovery | Stage 05; identity, key, fingerprint pills | "A new node from the 24 words alone finds the same key, fetches the backup, and restores it. Same identity, same fingerprint." |
